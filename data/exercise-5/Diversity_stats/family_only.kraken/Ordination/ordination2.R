...
setwd('/media/chrishah/STORAGE/Dropbox/Github/egrep_devel/R_analyses/ANALYSES_NEW/family_only.kraken/Ordination/')

coms<-as.data.frame(read.csv("../COI-trim30min100-merge-c3-id97-by-taxonomy-readcounts.kraken.family.for-R.csv"))
