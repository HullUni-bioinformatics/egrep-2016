...
setwd('/media/chrishah/STORAGE/Dropbox/Github/egrep_devel/R_analyses/ANALYSES_NEW/family_only.blast/Richness/')

table <- read.csv('../COI-trim30min100-merge-c3-id97-by-taxonomy-readcounts.blast.family.for-R.csv',row.names = 1)
...
#t = -2.1837, df = 15.357, p-value = 0.04488
#alternative hypothesis: true difference in means is not equal to 0
#95 percent confidence interval:
#  -10.7478268  -0.1410621
#sample estimates:
#  mean of x mean of y 
#9.333333 14.777778 
