...
setwd('/media/chrishah/STORAGE/Dropbox/Github/egrep_devel/R_analyses/ANALYSES_NEW/family_only.blast/Ordination/')

coms<-as.data.frame(read.csv("../COI-trim30min100-merge-c3-id97-by-taxonomy-readcounts.blast.family.for-R.csv"))
