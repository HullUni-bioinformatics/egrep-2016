...
setwd('/media/chrishah/STORAGE/Dropbox/Github/egrep_devel/R_analyses/ANALYSES_NEW/denovo_OTUs/Rarefaction/')
...
pdf(file="read_rarefaction_BW_by_sample_ASH.pdf")
...
pdf(file="read_rarefaction_BW_by_sample_OAK.pdf")
...
pdf(file="read_rarefaction_BW_by_sample_HAZ.pdf")
...
pdf(file="read_rarefaction_BW_by_sample_BET.pdf")
...
pdf(file="read_rarefaction_BW_by_sample_BEE.pdf")
