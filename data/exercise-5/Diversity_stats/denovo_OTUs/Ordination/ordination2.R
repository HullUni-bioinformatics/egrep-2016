...
setwd('/media/chrishah/STORAGE/Dropbox/Github/egrep_devel/R_analyses/ANALYSES_NEW/denovo_OTUs/Ordination/')

coms<-as.data.frame(read.csv("../COI-trim30min100-merge-c3-id97-OTU-denovo.for-R.csv"))
...
mantel(coms.trim.qjdis,coms.trimB.jdis)  # significantly correlated p = 0.015 (quantitative vs binary)
...
pdf('NMDS_trees_denovo_OTUs.pdf')
...
pdf('NMDS_forest_denovo_OTUs.pdf')
#plot(coms.trim.qjmds,display="sites") 
fig <- ordiplot(coms.trim.qjmds, type='n')
